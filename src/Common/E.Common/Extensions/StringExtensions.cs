    ...
    public static class StringExtensions
    {
        ...
        public static float ToFloat(this string str, int digits = -1)
        {
            try
            {
                ...
                {
                    double.TryParse(str, out var doubleResult);
                    var result = Convert.ToSingle(Math.Round(doubleResult, digits));
                    return result;
                }
            }
            catch (Exception)
        ...
        */
        ...
        #endregion
#if NETSTANDARD2_0
        public static bool Contains(this string str, char @char)
        {
